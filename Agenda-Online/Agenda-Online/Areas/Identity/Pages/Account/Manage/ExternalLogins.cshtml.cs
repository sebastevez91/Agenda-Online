...
namespace Agenda_Online.Areas.Identity.Pages.Account.Manage
{
    public class ExternalLoginsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostRemoveLoginAsync(string loginProvider, string providerKey)
        {
            ...
            if (!result.Succeeded)
            {
                StatusMessage = "El inicio de sesión externo no fue eliminado.";
        ...
        public async Task<IActionResult> OnGetLinkLoginCallbackAsync()
        {
            ...
            if (info == null)
            {
                throw new InvalidOperationException($"Se produjo un error inesperado al cargar la información de inicio de sesión externa.");
            }
